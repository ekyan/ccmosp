...
/**
 * 人事汎用バイナリ履歴情報DAOインターフェース。
 */
public interface HumanBinaryHistoryDaoInterface extends BaseDaoInterface {
	
	/**
	 * 人事汎用バイナリ履歴情報を取得する。<br>
	 * 個人ID・人事項目区分と有効日から人事汎用バイナリ履歴情報を取得する。<br>
	 ...
	 * 個人ID・人事項目区分(人事汎用項目)から人事汎用バイナリ履歴情報リストを取得する。<br>
