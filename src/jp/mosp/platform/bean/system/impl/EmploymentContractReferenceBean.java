...
public class EmploymentContractReferenceBean extends PlatformBean implements EmploymentContractReferenceBeanInterface {
	 ...
	 */
	protected EmploymentContractReferenceBean(MospParams mospParams, Connection connection) {
		super(mospParams, connection);
	}
	
	@Override
	public void initBean() throws MospException {
		dao = (EmploymentContractDaoInterface)createDao(EmploymentContractDaoInterface.class);
	}
	...
	@Override
	public EmploymentContractDtoInterface findForkey(long id) throws MospException {
		BaseDto dto = findForKey(dao, id, false);
		if (dto != null) {
			return (EmploymentContractDtoInterface)dto;
		}
		return null;
	}
