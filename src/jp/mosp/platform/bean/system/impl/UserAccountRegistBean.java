...
public class UserAccountRegistBean extends PlatformBean implements UserAccountRegistBeanInterface {
	...
	public void initBean() throws MospException {
		// Beanを準備
		userRegist = (UserMasterRegistBeanInterface)createBean(UserMasterRegistBeanInterface.class);
		extraRoleRegist = (UserExtraRoleRegistBeanInterface)createBean(UserExtraRoleRegistBeanInterface.class);
	...
	protected void update(String userId, Date activateDate, Object object) throws MospException {
		...
		if (userDto == null) {
			// エラーメッセージを追加
			PlatformMessageUtility.addErrorCodeNotExistBeforeDate(mospParams, userId);
			// 処理終了
			return;
		}
		// ユーザ情報に更新パラメータを設定
