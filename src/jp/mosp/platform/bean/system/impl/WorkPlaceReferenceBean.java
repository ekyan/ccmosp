...
public class WorkPlaceReferenceBean extends PlatformBean implements WorkPlaceReferenceBeanInterface {
	 ...
	 */
	public WorkPlaceReferenceBean(MospParams mospParams, Connection connection) {
	...
	@Override
	public WorkPlaceDtoInterface findForkey(long id) throws MospException {
		BaseDto dto = findForKey(dao, id, false);
		if (dto != null) {
			return (WorkPlaceDtoInterface)dto;
		}
		return null;
	}
