...
public class BankBranchReferenceBean extends PlatformBean implements BankBranchReferenceBeanInterface {
	 ...
	 * 銀行マスタDAOクラス。
	 */
	private BankBranchDaoInterface dao;
	 ...
	 */
	protected BankBranchReferenceBean(MospParams mospParams, Connection connection) {
	...
	@Override
	public String getBranchName(String bankCode, String branchCode) throws MospException {
		// 銀行名準備
		String branchName = "";
		// 銀行情報取得
		BankBranchDtoInterface dto = findForKey(bankCode, branchCode);
		if (dto != null) {
