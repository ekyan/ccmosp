...
public class BankBaseReferenceBean extends PlatformBean implements BankBaseReferenceBeanInterface {
	 ...
	 */
	protected BankBaseReferenceBean(MospParams mospParams, Connection connection) {
		super(mospParams, connection);
	}
	
	@Override
	public void initBean() throws MospException {
		dao = (BankBaseDaoInterface)createDao(BankBaseDaoInterface.class);
	}
	...
	@Override
	public String getBankName(String code) throws MospException {
		// 銀行名準備
		String bankName = "";
		// 銀行情報取得
		BankBaseDtoInterface dto = findForKey(code);
		if (dto != null) {
