 ...
 * 勤務地マスタ登録インターフェース。
 */
public interface WorkPlaceRegistBeanInterface {
	
	/**
	 * 登録用DTOを取得する。<br>
	 * @return 初期DTO
	 */
	WorkPlaceDtoInterface getInitDto();
	 ...
	 */
	void insert(WorkPlaceDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void add(WorkPlaceDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(WorkPlaceDtoInterface dto) throws MospException;
