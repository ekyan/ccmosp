...
public interface PositionRegistBeanInterface {
	 ...
	 */
	void insert(PositionDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void add(PositionDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(PositionDtoInterface dto) throws MospException;
