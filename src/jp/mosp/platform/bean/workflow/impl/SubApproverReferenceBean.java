...
public class SubApproverReferenceBean extends PlatformBean implements SubApproverReferenceBeanInterface {
	 ...
	 */
	protected SubApproverReferenceBean(MospParams mospParams, Connection connection) {
	...
	@Override
	public SubApproverDtoInterface findForDate(String personalId, int workflowType, Date targetDate)
			throws MospException {
		return dao.findForDate(personalId, workflowType, targetDate);
	}
