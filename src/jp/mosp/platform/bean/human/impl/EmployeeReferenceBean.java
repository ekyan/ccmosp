...
public class EmployeeReferenceBean extends PlatformBean implements EmployeeReferenceBeanInterface {
	...
	public void initBean() throws MospException {
		...
		suspensionRefer = (SuspensionReferenceBeanInterface)createBean(SuspensionReferenceBeanInterface.class);
		retirementRefer = (RetirementReferenceBeanInterface)createBean(RetirementReferenceBeanInterface.class);
		concurrentRefer = (ConcurrentReferenceBeanInterface)createBean(ConcurrentReferenceBeanInterface.class);
	}
