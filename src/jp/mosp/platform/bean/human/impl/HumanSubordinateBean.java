 ...
 * 部下検索処理(抽象)。<br>
 */
public abstract class HumanSubordinateBean extends HumanSearchBean {
	...
	/**
	 * {@link HumanSearchBean#HumanSearchBean(MospParams, Connection)}を実行する。<br>
	 * @param mospParams MosP処理情報
	 * @param connection DBコネクション
	 */
	public HumanSubordinateBean(MospParams mospParams, Connection connection) {
