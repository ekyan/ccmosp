...
public interface RetirementReferenceBeanInterface {
	 ...
	 */
	RetirementDtoInterface getRetireInfo(String personalId, Date targetDate) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、SQLの作成及び実行に失敗した場合
	 */
	RetirementDtoInterface findForKey(long id) throws MospException;
