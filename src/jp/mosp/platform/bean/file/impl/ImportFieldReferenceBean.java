...
public class ImportFieldReferenceBean extends PlatformBean implements ImportFieldReferenceBeanInterface {
	...
	public void initBean() throws MospException {
		dao = (ImportFieldDaoInterface)createDao(ImportFieldDaoInterface.class);
	}
	
	@Override
	public List<ImportFieldDtoInterface> getImportFieldList(String importCode) throws MospException {
		return dao.findForList(importCode);
	}
