...
public class ApprovalCardAction extends TimeAction {
	...
	protected void setAttendanceValues() throws MospException {
		...
		if (dto.getMinutelyHolidayA() == 1) {
			minutelyHolidayA = mospParams.getName("AllTime");
		}
		
		// 分単位休暇A全休
		vo.setLblAllMinutelyHolidayA(minutelyHolidayA);
		// 分単位休暇A時間
		vo.setLblMinutelyHolidayATime(getTimeTimeFormat(dto.getMinutelyHolidayATime()));
		// 分単位休暇A情報取得
		goOutList = timeReference().goOut().getMinutelyHolidayAList(personalId, targetDate);
		// 分単位休暇A情報設定
		for (GoOutDtoInterface goOutDto : goOutList) {
			switch (goOutDto.getTimesGoOut()) {
				case 1:
					vo.setLblMinutelyHolidayATime1(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				case 2:
					vo.setLblMinutelyHolidayATime2(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				case 3:
					vo.setLblMinutelyHolidayATime3(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				case 4:
					vo.setLblMinutelyHolidayATime4(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				default:
					break;
		...
		if (dto.getMinutelyHolidayB() == 1) {
			minutelyHolidayB = mospParams.getName("AllTime");
		}
		
		// 分単位休暇B全休
		vo.setLblAllMinutelyHolidayB(minutelyHolidayB);
		// 分単位休暇B時間
		vo.setLblMinutelyHolidayBTime(getTimeTimeFormat(dto.getMinutelyHolidayBTime()));
		// 分単位休暇B情報取得
		goOutList = timeReference().goOut().getMinutelyHolidayBList(personalId, targetDate);
		// 分単位休暇B情報設定
		for (GoOutDtoInterface goOutDto : goOutList) {
			switch (goOutDto.getTimesGoOut()) {
				case 1:
					vo.setLblMinutelyHolidayBTime1(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				case 2:
					vo.setLblMinutelyHolidayBTime2(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				case 3:
					vo.setLblMinutelyHolidayBTime3(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				case 4:
					vo.setLblMinutelyHolidayBTime4(getTimeWaveFormat(goOutDto.getGoOutStart(), goOutDto.getGoOutEnd(),
							goOutDto.getWorkDate()));
					break;
				default:
					break;
