...
public class TotalTimeCardAction extends TotalTimeBaseAction {
	...
	protected void setDtoWorkTimeFields(TotalTimeDataDtoInterface dto) throws MospException {
		...
		// 減額対象時間
		dto.setDecreaseTime(getTimeValue(getInt(vo.getTxtDecreaseTimeHour()), getInt(vo.getTxtDecreaseTimeMinute())));
		// 直行回数
		dto.setDirectStart(getInt(vo.getTxtTimesNonstop()));
		// 直帰回数
		dto.setDirectEnd(getInt(vo.getTxtTimesNoreturn()));
		// 45時間超残業時間
		dto.setFortyFiveHourOvertime(getTimeValue(getInt(vo.getTxt45HourOverTimeHour()),
				getInt(vo.getTxt45HourOverTimeMinute())));
		...
		// 深夜時間
		dto.setLateNight(getTimeValue(getInt(vo.getTxtLateNightHour()), getInt(vo.getTxtLateNightMinute())));
		
		// 合計遅刻時間
		dto.setLateTime(getTimeValue(getInt(vo.getTxtLateTimeHour()), getInt(vo.getTxtLateTimeMinute())));
		// 遅刻30分以上時間
		dto.setLateThirtyMinutesOrMoreTime(getTimeValue(vo.getTxtLateThirtyMinutesOrMoreTimeHour(),
				vo.getTxtLateThirtyMinutesOrMoreTimeMinute()));
		// 遅刻30分未満時間
		...
		// 私用外出時間
		dto.setPrivateTime(getTimeValue(getInt(vo.getTxtPrivateHour()), getInt(vo.getTxtPrivateMinute())));
		// 公用外出時間
		dto.setPublicTime(getTimeValue(getInt(vo.getTxtPublicHour()), getInt(vo.getTxtPublicMinute())));
		// TODO 分単位休暇
		dto.setMinutelyHolidayATime(getTimeValue(getInt(vo.getTxtMinutelyHolidayAHour()),
				getInt(vo.getTxtMinutelyHolidayAMinute())));
		dto.setMinutelyHolidayBTime(getTimeValue(getInt(vo.getTxtMinutelyHolidayBHour()),
				getInt(vo.getTxtMinutelyHolidayBMinute())));
		// 休憩時間
		dto.setRestTime(getTimeValue(getInt(vo.getTxtRestTimeHour()), getInt(vo.getTxtRestTimeMinute())));
		// 深夜休憩時間
		dto.setRestLateNight(getTimeValue(getInt(vo.getTxtRestLateNightHour()), getInt(vo.getTxtRestLateNightMinute())));
		// 所定休出休憩時間
		dto.setRestWorkOnSpecificHoliday(getTimeValue(getInt(vo.getTxtRestWorkOnSpecificHour()),
				getInt(vo.getTxtRestWorkOnSpecificMinute())));
		// 法定休出休憩時間
		dto.setRestWorkOnHoliday(getTimeValue(getInt(vo.getTxtRestWorkOnLegalHour()),
				getInt(vo.getTxtRestWorkOnLegalMinute())));
		// 残業時間
		dto.setOvertime(getTimeValue(getInt(vo.getTxtOverTimeHour()), getInt(vo.getTxtOverTimeMinute())));
		// 法定内残業時間
		dto.setOvertimeIn(getTimeValue(getInt(vo.getTxtOverTimeInHour()), getInt(vo.getTxtOverTimeInMinute())));
		// 法定外残業時間
		dto.setOvertimeOut(getTimeValue(getInt(vo.getTxtOverTimeOutHour()), getInt(vo.getTxtOverTimeOutMinute())));
		// 60時間超残業時間
		dto.setSixtyHourOvertime(getTimeValue(getInt(vo.getTxt60HourOverTimeHour()),
				getInt(vo.getTxt60HourOverTimeMinute())));
		// 所定休日時間外時間
		dto.setSpecificOvertime(getTimeValue(getInt(vo.getTxtSpecificOverTimeHour()),
				getInt(vo.getTxtSpecificOverTimeMiunte())));
		// 所定休日出勤日数
...
//		dto.setTimesLeaveEarly(getInt(vo.getTxtTimesLeaveEarly()));
		...
		// 平日時間外時間
		dto.setWeekDayOvertime(getTimeValue(getInt(vo.getTxtWeekDayOverTimeHour()),
				getInt(vo.getTxtWeekDayOverTimeMinute())));
		// 法定休出時間
		dto.setWorkOnHoliday(getTimeValue(getInt(vo.getTxtRestWorkOnLegalHour()),
				getInt(vo.getTxtRestWorkOnLegalMinute())));
		// 所定休出時間
		dto.setWorkOnSpecificHoliday(getTimeValue(getInt(vo.getTxtRestWorkOnSpecificHour()),
				getInt(vo.getTxtRestWorkOnSpecificMinute())));
		// 勤務時間
		dto.setWorkTime(getTimeValue(getInt(vo.getTxtWorkTimeHour()), getInt(vo.getTxtWorkTimeMinute())));
		// 出勤対象日数
		dto.setTimesTotalWorkDate(getInt(vo.getTxtTimesTotalWorkDate()));
		// 残業回数
		dto.setTimesOvertime(getInt(vo.getTxtTimesOvertime()));
		// 法定休出時間
		dto.setWorkOnHoliday(getTimeValue(getInt(vo.getTxtWorkOnHolidayHour()), getInt(vo.getTxtWorkOnHolidayMinute())));
		// 所定休出時間
		dto.setWorkOnSpecificHoliday(getTimeValue(getInt(vo.getTxtWorkSpecificOnHolidayHour()),
				getInt(vo.getTxtWorkSpecificOnHolidayMinute())));
		// 休日出勤回数
		dto.setTimesWorkingHoliday(getInt(vo.getTxtTimesWorkingHoliday()));
		
		// 合計早退時間
		dto.setLeaveEarlyTime(getTimeValue(getInt(vo.getTxtLeaveEarlyTimeHour()),
				getInt(vo.getTxtLeaveEarlyTimeMinute())));
		// 早退30分以上時間
		...
		// 所定勤務時間
		dto.setSpecificWorkTime(getTimeValue(getInt(vo.getTxtSpecificWorkTimeHour()),
				getInt(vo.getTxtSpecificWorkTimeMinute())));
		// 無給時短時間
		dto.setShortUnpaid(getTimeValue(getInt(vo.getTxtUnpaidShortTimeHour()),
				getInt(vo.getTxtUnpaidShortTimeMinute())));
	...
	protected void setDtoAllowanceFields(AllowanceDtoInterface dto, int allowance) throws MospException {
		...
		if (allowance == 0) {
			...
			dto.setAllowance(getInt(vo.getTxtTimesAllowance1()));
		} else if (allowance == 1) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO2);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance2()));
		} else if (allowance == 2) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO3);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance3()));
		} else if (allowance == 3) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO4);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance4()));
		} else if (allowance == 4) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO5);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance5()));
		} else if (allowance == 5) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO6);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance6()));
		} else if (allowance == 6) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO7);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance7()));
		} else if (allowance == 7) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO8);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance8()));
		} else if (allowance == 8) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO9);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance9()));
		} else if (allowance == 9) {
			dto.setAllowanceCode(TimeConst.CODE_ALLOWANCE_INFO10);
			dto.setAllowance(getInt(vo.getTxtTimesAllowance10()));
		}
	}
	...
	protected void setVoWorkTimeFields(TotalTimeDataDtoInterface dto) throws MospException {
		...
		// TODO 分単位休暇時間
		vo.setTxtMinutelyHolidayAHour(String.valueOf(dto.getMinutelyHolidayATime() / TimeConst.CODE_DEFINITION_HOUR));
		vo.setTxtMinutelyHolidayAMinute(String.valueOf(dto.getMinutelyHolidayATime() % TimeConst.CODE_DEFINITION_HOUR));
		vo.setTxtMinutelyHolidayBHour(String.valueOf(dto.getMinutelyHolidayBTime() / TimeConst.CODE_DEFINITION_HOUR));
		vo.setTxtMinutelyHolidayBMinute(String.valueOf(dto.getMinutelyHolidayBTime() % TimeConst.CODE_DEFINITION_HOUR));
		// 深夜休憩時間
