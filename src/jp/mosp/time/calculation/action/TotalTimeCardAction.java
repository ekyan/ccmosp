...
public class TotalTimeCardAction extends TotalTimeBaseAction {
	...
	protected void setDtoWorkTimeFields(TotalTimeDataDtoInterface dto) throws MospException {
		...
		// 分単位休暇
		dto.setMinutelyHolidayATime(getTimeValue(vo.getTxtMinutelyHolidayAHour(), vo.getTxtMinutelyHolidayAMinute()));
		dto.setMinutelyHolidayBTime(getTimeValue(vo.getTxtMinutelyHolidayBHour(), vo.getTxtMinutelyHolidayBMinute()));
		// 休憩時間
