...
public class SpecialHolidayManagementAction extends TimeAction {
	 ...
	 * 有効日決定コマンド。<br>
	 * <br>
	 * 入力した有効日時点で有効な勤務地、雇用契約、所属、職位の情報を取得し、
	 * そのコードと名称をそれぞれのプルダウンに表示する。<br>
	 */
	...
	protected void show() throws MospException {
		// VO準備
		SpecialHolidayManagementVo vo = (SpecialHolidayManagementVo)mospParams.getVo();
		// ページ繰り設定
