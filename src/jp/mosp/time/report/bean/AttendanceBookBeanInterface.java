 ...
 * 出勤簿作成インターフェース。
 */
public interface AttendanceBookBeanInterface {
	...
	/**
	 * 個人ID及び対象日で出勤簿を作成する。<br>
	 * @param personalId 取得対象個人ID
	 * @param targetDate 取得対象日
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	void makeAttendanceBook(String personalId, Date targetDate) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	void makeAttendanceBook(String personalId, int year, int month) throws MospException;
