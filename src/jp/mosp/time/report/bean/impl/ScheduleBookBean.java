...
public class ScheduleBookBean extends PlatformBean implements ScheduleBookBeanInterface {
	...
	@Override
	public void makeScheduleBook(String personalId, Date targetDate) throws MospException {
		// 勤怠一覧(予定簿)情報取得
		List<AttendanceListDto> attendanceList = attendanceListRefer.getScheduleList(personalId, targetDate);
		// 処理結果確認
