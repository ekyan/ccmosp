...
public interface PaidHolidayPointDateRegistBeanInterface {
	 ...
	 */
	void insert(PaidHolidayPointDateDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void add(PaidHolidayPointDateDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(PaidHolidayPointDateDtoInterface dto) throws MospException;
