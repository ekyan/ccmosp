...
/**
 * 勤怠集計欠勤データ登録インターフェース。<br>
 */
public interface TotalAbsenceRegistBeanInterface {
	
	/**
	 * 登録用DTOを取得する。<br>
	 * @return 初期DTO
	 */
	TotalAbsenceDtoInterface getInitDto();
	 ...
	 */
	void insert(TotalAbsenceDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(TotalAbsenceDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void regist(TotalAbsenceDtoInterface dto) throws MospException;
