...
/**
 * ストック休暇設定参照インターフェース。<br>
 */
public interface StockHolidayReferenceBeanInterface {
	 ...
	 */
	StockHolidayDtoInterface getStockHolidayInfo(String paidHolidayCode, Date targetDate) throws MospException;
	
	/**
	 * ストック休暇マスタからレコードを取得する。<br>
