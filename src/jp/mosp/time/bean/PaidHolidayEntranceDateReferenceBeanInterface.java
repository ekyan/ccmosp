 ...
 */
public interface PaidHolidayEntranceDateReferenceBeanInterface {
	
	/**
	 * 有給休暇自動付与(入社日)マスタ取得。
	 * <p>
	 * 有給休暇コードと対象日と勤続勤務月数から有給休暇自動付与(入社日)マスタを取得。
	 * </p>
	 * @param paidHolidayCode 有給休暇コード
	 * @param targetDate 対象年月日
	 * @param workMonth 勤続勤務月数
	 * @return 有給休暇自動付与(入社日)マスタ
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	PaidHolidayEntranceDateDtoInterface getPaidHolidayEntranceDateInfo(String paidHolidayCode, Date targetDate,
