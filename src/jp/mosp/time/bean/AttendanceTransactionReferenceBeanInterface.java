...
/**
 * 勤怠トランザクション参照インターフェース。
 */
public interface AttendanceTransactionReferenceBeanInterface {
	 ...
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	Set<Date> findForDate(String personalId, Date firstDate, Date lastDate) throws MospException;
