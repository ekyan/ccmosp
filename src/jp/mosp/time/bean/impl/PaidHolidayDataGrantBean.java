...
public class PaidHolidayDataGrantBean extends TimeApplicationBean implements PaidHolidayDataGrantBeanInterface {
	...
	public void initBean() throws MospException {
		...
		paidHolidayDataRegist = (PaidHolidayDataRegistBeanInterface)createBean(
				PaidHolidayDataRegistBeanInterface.class);
		paidHolidayGrantRefer = (PaidHolidayGrantReferenceBeanInterface)createBean(
		...
		paidHolidayProportionallyRefer = (PaidHolidayProportionallyReferenceBeanInterface)createBean(
				PaidHolidayProportionallyReferenceBeanInterface.class);
		paidHolidayFirstYearRefer = (PaidHolidayFirstYearReferenceBeanInterface)createBean(
				PaidHolidayFirstYearReferenceBeanInterface.class);
		paidHolidayPointDateRefer = (PaidHolidayPointDateReferenceBeanInterface)createBean(
				PaidHolidayPointDateReferenceBeanInterface.class);
		humanHistoryRefer = (HumanHistoryReferenceBeanInterface)createBean(HumanHistoryReferenceBeanInterface.class);
