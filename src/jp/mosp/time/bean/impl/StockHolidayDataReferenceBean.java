...
public class StockHolidayDataReferenceBean extends PlatformBean implements StockHolidayDataReferenceBeanInterface {
	 ...
	 */
	public StockHolidayDataReferenceBean(MospParams mospParams, Connection connection) {
	...
	@Override
	public List<StockHolidayDataDtoInterface> findForInfoList(String personalId, Date targetDate) throws MospException {
