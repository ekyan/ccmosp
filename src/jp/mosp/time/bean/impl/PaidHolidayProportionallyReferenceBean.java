...
public class PaidHolidayProportionallyReferenceBean extends PlatformBean
	 ...
	 */
	public PaidHolidayProportionallyReferenceBean(MospParams mospParams, Connection connection) {
		super(mospParams, connection);
	}
	
	@Override
	public void initBean() throws MospException {
		dao = (PaidHolidayProportionallyDaoInterface)createDao(PaidHolidayProportionallyDaoInterface.class);
	}
	...
	public PaidHolidayProportionallyDtoInterface findForKey(String paidHolidayCode, Date activateDate,
		...
		return dao.findForKey(paidHolidayCode, activateDate, prescribedWeeklyWorkingDays,
