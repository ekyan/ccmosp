...
public class PaidHolidayRegistBean extends PlatformBean implements PaidHolidayRegistBeanInterface {
	 ...
	 */
	public PaidHolidayRegistBean(MospParams mospParams, Connection connection) {
	...
	public void initBean() throws MospException {
		// DAO準備
		dao = (PaidHolidayDaoInterface)createDao(PaidHolidayDaoInterface.class);
	}
	...
	protected void addCodeIsUsedMessage(String code, ApplicationDtoInterface dto) {
		String columnName = mospParams.getProperties().getName("PaidVacation")
