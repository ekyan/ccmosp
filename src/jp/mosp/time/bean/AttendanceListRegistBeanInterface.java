...
public interface AttendanceListRegistBeanInterface {
	 ...
	 * @param oldMinutely1HolidayList 旧分単位休暇1リスト
	...
	/**
	 * 勤怠申請時に分単位休暇の全休を取得している場合、
	 * 始業終業時間の入力は不可であるメッセージを表示する。
	 * @param attendanceDto  勤怠データDTOインターフェース
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	void checkMinutelyHoliday(AttendanceDtoInterface attendanceDto) throws MospException;
