 ...
 * 勤怠データ外出情報参照インターフェース。
 */
public interface GoOutReferenceBeanInterface {
	...
	/**
	 * 勤怠データ分単位休暇A情報リストを取得する。<br>
	 * 社員コードと勤務日で勤務回数1の勤怠データ分単位休暇A情報リストを取得する。<br>
	 * @param personalId 個人ID
	 * @param workDate   勤務日
	 * @return 勤怠データ分単位休暇A情報リスト
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	List<GoOutDtoInterface> getMinutelyHolidayAList(String personalId, Date workDate) throws MospException;
	
	/**
	 * 勤怠データ分単位休暇B情報リストを取得する。<br>
	 * 社員コードと勤務日で勤務回数Bの勤怠データ分単位休暇1情報リストを取得する。<br>
	 * @param personalId 個人ID
	 * @param workDate   勤務日
	 * @return 勤怠データ分単位休暇B情報リスト
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	List<GoOutDtoInterface> getMinutelyHolidayBList(String personalId, Date workDate) throws MospException;
