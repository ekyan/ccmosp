 ...
 */
public interface PaidHolidayEntranceDateRegistBeanInterface {
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void add(PaidHolidayEntranceDateDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(PaidHolidayEntranceDateDtoInterface dto) throws MospException;
