...
/**
 * 勤怠集計特別休暇データ登録インターフェース。<br>
 */
public interface TotalLeaveRegistBeanInterface {
	 ...
	 */
	void insert(TotalLeaveDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(TotalLeaveDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void regist(TotalLeaveDtoInterface dto) throws MospException;
