 ...
 * 有給休暇初年度付与参照インターフェース。
 */
public interface PaidHolidayFirstYearReferenceBeanInterface {
	
	/**
	 * 有給休暇初年度付与マスタ取得。
	 * <p>
	 * 有給休暇コードと対象日と入社月から有給休暇初年度付与マスタを取得。
	 * </p>
	 ...
	 */
	PaidHolidayFirstYearDtoInterface getPaidHolidayFirstYearInfo(String paidHolidayCode, Date targetDate,
