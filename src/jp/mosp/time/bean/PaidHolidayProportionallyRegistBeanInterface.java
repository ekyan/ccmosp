...
public interface PaidHolidayProportionallyRegistBeanInterface {
	 ...
	 */
	void insert(PaidHolidayProportionallyDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void add(PaidHolidayProportionallyDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(PaidHolidayProportionallyDtoInterface dto) throws MospException;
