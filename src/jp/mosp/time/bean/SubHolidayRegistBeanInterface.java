...
public interface SubHolidayRegistBeanInterface {
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void update(SubHolidayDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void regist(SubHolidayDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException インスタンスの取得、或いはSQL実行に失敗した場合
	 */
	void delete(SubHolidayDtoInterface dto) throws MospException;
