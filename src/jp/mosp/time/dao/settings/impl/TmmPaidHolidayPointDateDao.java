...
public class TmmPaidHolidayPointDateDao extends PlatformDao implements PaidHolidayPointDateDaoInterface {
	...
	@Override
	public PaidHolidayPointDateDtoInterface findForInfo(String paidHolidayCode, Date activateDate, int timesPointDate)
			throws MospException {
		try {
			index = 1;
			StringBuffer sb = getSelectQuery(getClass());
	...
	@Override
	public List<PaidHolidayPointDateDtoInterface> findForSearch(Map<String, Object> param) {
		// 処理なし
		return null;
	}
