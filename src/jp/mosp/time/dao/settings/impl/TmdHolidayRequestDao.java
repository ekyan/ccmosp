...
public class TmdHolidayRequestDao extends PlatformDao implements HolidayRequestDaoInterface {
	...
	public List<HolidayRequestDtoInterface> findForRequestList(String personalId, Date acquisitionDate,
		...
		try {
			...
			sb.append(PftWorkflowDao.COL_WORKFLOW_STATUS);
			sb.append(" <> '");
			sb.append(PlatformConst.CODE_STATUS_DRAFT);
			sb.append("'");
			sb.append(and());
			sb.append(PftWorkflowDao.COL_WORKFLOW_STATUS);
			sb.append(" <> '");
			sb.append(PlatformConst.CODE_STATUS_WITHDRAWN);
			sb.append("'");
			sb.append(rightParenthesis());
			prepareStatement(sb.toString());
			setParam(index++, personalId);
	...
	/*
	@Override
	public List<HolidayRequestDtoInterface> findForListOnWorkflow(String personalId, Date requestDate)
	...
	*/
	...
	@Override
	public List<HolidayRequestDtoInterface> findForSpecialHolidayList(String personalId, String holidayCode,
		...
		try {
			...
			sb.append(equal(COL_PERSONAL_ID));
			sb.append(and());
			sb.append(equal(COL_HOLIDAY_TYPE1, 2));
			sb.append(and());
			sb.append(equal(COL_HOLIDAY_TYPE2));
			sb.append(and());
			sb.append(lessEqual(COL_REQUEST_START_DATE));
			sb.append(and());
			sb.append(greaterEqual(COL_REQUEST_START_DATE));
			prepareStatement(sb.toString());
			setParam(index++, personalId);
	...
	@Override
	public List<HolidayRequestDtoInterface> findForOtherHolidayList(String personalId, String holidayCode,
			Date requestDate) throws MospException {
		try {
			index = 1;
			StringBuffer sb = getSelectQuery(getClass());
			...
			sb.append(equal(COL_PERSONAL_ID));
			sb.append(and());
			sb.append(equal(COL_HOLIDAY_TYPE1, 3));
			sb.append(and());
			sb.append(equal(COL_HOLIDAY_TYPE2));
			sb.append(and());
			sb.append(lessEqual(COL_REQUEST_START_DATE));
	...
	@Override
	public List<HolidayRequestDtoInterface> findForAbsenceList(String personalId, String holidayCode, Date requestDate)
			throws MospException {
		try {
			index = 1;
			StringBuffer sb = getSelectQuery(getClass());
			...
			sb.append(equal(COL_PERSONAL_ID));
			sb.append(and());
			sb.append(equal(COL_HOLIDAY_TYPE1, 4));
			sb.append(and());
			sb.append(equal(COL_HOLIDAY_TYPE2));
			sb.append(and());
			sb.append(lessEqual(COL_REQUEST_START_DATE));
	...
	@Override
	public List<HolidayRequestDtoInterface> findForWorkflowStatus(String personalId, int workflowStage,
		...
		try {
			...
			setParam(index++, TimeConst.CODE_FUNCTION_VACATION);
			executeQuery();
			return mappingAll();
		} catch (Throwable e) {
			throw new MospException(e);
