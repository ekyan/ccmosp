...
public interface ApplicationDaoInterface extends BaseDaoInterface {
	 ...
	 * @throws MospException SQLの作成に失敗した場合、或いはSQL例外が発生した場合
	 */
	ApplicationDtoInterface findForInfo(String applicationCode, Date activateDate) throws MospException;
	 ...
	 * @throws MospException SQLの作成に失敗した場合、或いはSQL例外が発生した場合
	 */
	List<ApplicationDtoInterface> findForInfoList(String workSettingCode, Date targetDate) throws MospException;
