...
public interface SubstituteDaoInterface extends BaseDaoInterface {
	...
	/**
	 * 個人IDと承認段階から振替休日データを取得する。<br>
	 * @param personalId 対象個人ID
	 * @param approverState 承認段階
	 * @return 振替休日データリスト
	 * @throws MospException SQLの作成に失敗した場合、或いはSQL例外が発生した場合
	 */
	List<SubstituteDtoInterface> findForWorkflow(String personalId, int approverState) throws MospException;
