...
public interface HolidayDataDaoInterface extends BaseDaoInterface {
	 ...
	 * 最大有効日レコードのクエリを取得する。
	 * </p>
	 * @return 個人IDに紐づく有効日が最大であるレコード取得クエリ
	 */
	 ...
	 * @throws MospException SQLの作成に失敗した場合、或いはSQL例外が発生した場合
	 */
	List<HolidayDataDtoInterface> findForActivateDate(Date activateDate, String holidayCode, int holidayType)
			throws MospException;
