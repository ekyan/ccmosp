...
import = "jp.mosp.time.comparator.settings.SubHolidayRequestStateComparator"
...
<% } %>
		...
		<tr>
			<th class="ListSelectTh"><%= params.getName("Holiday") %></th>
	...
	<table class="LeftListTable LeftRequestListTable" id="list">
		<thead>
			<tr>
				...
				<th class="ListSortTh" id="thState"       onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= SubHolidayRequestStateComparator.class.getName() %>'), '<%= SubHolidayRequestAction.CMD_SORT %>')"><%= params.getName("State") %><%= PlatformUtility.getSortMark(SubHolidayRequestStateComparator.class.getName(), params) %></th>
				<th class="ListSortTh" id="thApprover"    onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= SubHolidayRequestApproverNameComparator.class.getName() %>'), '<%= SubHolidayRequestAction.CMD_SORT %>')"><%= params.getName("Approver") %><%= PlatformUtility.getSortMark(SubHolidayRequestApproverNameComparator.class.getName(), params) %></th>
