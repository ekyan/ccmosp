	...
	<table class="InputTable" id="workTypeChangeRequest_tblEdit">
		...
		<tr>
			...
			<td class="InputTd" id="tdEndDate">
				...
				<%= params.getName("Day") %>
				<input type="checkbox" class="CheckBox" id="ckbEndDate" name="ckbEndDate" value="<%= MospConst.CHECKBOX_ON %>" <%= HtmlUtility.getChecked(vo.getCkbEndDate()) %>>&nbsp;<span><%= params.getName("Period", "Given") %></span>
			</td>
		</tr>
		<tr>
