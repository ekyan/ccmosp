...
import = "jp.mosp.time.comparator.settings.OvertimeRequestStateComparator"
	...
	<table class="LeftListTable LeftRequestListTable" id="list">
		<thead>
			<tr>
				...
				<th class="ListSortTh" id="thState" onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= OvertimeRequestStateComparator.class.getName() %>'), '<%= OvertimeRequestAction.CMD_SORT %>')"><%= params.getName("State") %><%= PlatformUtility.getSortMark(OvertimeRequestStateComparator.class.getName(), params) %></th>
				<th class="ListSortTh" id="thApprover" onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= OvertimeRequestApproverNameComparator.class.getName() %>'), '<%= OvertimeRequestAction.CMD_SORT %>')"><%= params.getName("Approver") %><%= PlatformUtility.getSortMark(OvertimeRequestApproverNameComparator.class.getName(), params) %></th>
