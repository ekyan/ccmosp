		...
		<tbody>
			...
			<tr>
				...
				<td id="tdSearchPaidHolidayDate" class="InputTd">
					<select name="pltSearchPaidHoliday" id="pltSearchPaidHoliday" class="Name15PullDown">
				...
				<td class="InputTd">
					<select name="pltSearchGrant" id="pltSearchGrant" class="Name3PullDown">
			...
			<tr>
				...
				<td class="InputTd">
					<select name="pltSearchEmployment" id="pltSearchEmployment" class="Name15PullDown">
			...
			<tr>
				...
				<td class="InputTd">
					<select name="pltSearchPosition" id="pltSearchPosition" class="Name15PullDown">
...
<%--
		<button type="button" class="HiddenInsertButton" onclick="submitRegist(event, 'paidHolidayDataSearch', null, '<%= PaidHolidayDataGrantListAction.CMD_OTHER_BATCH_UPDATE3 %>');"><%= params.getName("Update","Hour","GoingWork","Rate","Process") %></button>
--%>
	</span>
