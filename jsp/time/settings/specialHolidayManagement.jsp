...
<div class="List">
	<table class="LeftListTable" id="list">
		<tr>
			...
			<th class="ListSortTh" id="thHolidayType"		onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= HolidayManagementListHolidayCodeComparator.class.getName() %>'), '<%= SpecialHolidayManagementAction.CMD_SORT %>');"><%= params.getName("Vacation","Classification") %><%= PlatformUtility.getSortMark(HolidayManagementListHolidayCodeComparator.class.getName(), params) %></th>
