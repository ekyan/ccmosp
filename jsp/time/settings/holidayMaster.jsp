	...
	<table class="InputTable" id="tblCard">
		...
		<tbody>
			<tr>
				...
				<td class="TitleTd"><%= params.getName("Vacation","Type") %></td>
				<td class="InputTd">
	...
	<table class="InputTable">
		...
		<tbody>
			<tr>
				...
				<td class="TitleTd"><%= params.getName("Vacation","Code") %></td>
				<td class="InputTd">
...
<div class="Button">
	<button type="button" class="Name8Button" onclick="submitTransfer(event, null, null, null, '<%= SpecialHolidayHistoryAction.CMD_SHOW %>');"><%= params.getName("Specially","Vacation","Giving") %></button>
	<button type="button" class="Name8Button" onclick="submitTransfer(event, null, null, null, '<%= OtherHolidayHistoryAction.CMD_SHOW %>');"><%= params.getName("Others","Vacation","Giving") %></button>
</div>
