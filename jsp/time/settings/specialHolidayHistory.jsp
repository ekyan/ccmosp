...
%>
<div class="Button">
	<button type="button" id="btn" class="Name6Button" onclick="submitTransfer(event, null, null, null, '<%= SpecialHolidayManagementAction.CMD_SHOW %>');"><%= params.getName("Specially") %><%= params.getName("Vacation") %><%= params.getName("Confirmation") %></button>
</div>
<div class="List">
...
%>
				...
				<a onclick="submitTransfer(event, 'divEdit', null, null, '<%= SpecialHolidayHistoryAction.CMD_INSERT_MODE %>')"><%= params.getName("FrontWithCornerParentheses") %><%= params.getName("New") %><%= params.getName("Insert") %><%= params.getName("BackWithCornerParentheses") %></a>
<%
} else {
%>
	...
	<table class="ButtonTable" id="tblRegistButton">
		<tr>
			<td class="ButtonTd" id="">
				<button type="button" id="btnRegist" class="Name2Button" onclick="submitRegist(event, '', checkHolidayGiving, '<%= SpecialHolidayHistoryAction.CMD_REGISTER %>');"><%= params.getName("Insert") %></button>
			</td>
		</tr>
	</table>
</div>
<div class="List">
	...
	<table class="ButtonTable">
		<tr>
			<td class="ButtonTd" id="">
				<button type="button" id="btnSearch" class="Name2Button" onclick="submitTransfer(event, null, null, null, '<%= SpecialHolidayHistoryAction.CMD_SEARCH %>');"><%= params.getName("Search") %></button>
			</td>
		</tr>
	</table>
</div>
	...
	<table class="LeftListTable" id="list">
		<thead>
			<tr>
				...
				<th class="ListSortTh" id="thActivateDate" onclick="submitTransfer(event, null, null, new Array('<%=PlatformConst.PRM_TRANSFERRED_SORT_KEY%>', '<%=ActivateDateComparator.class.getName()%>'), '<%=SpecialHolidayHistoryAction.CMD_SORT%>');"><%=params.getName("GrantDate")%><%=PlatformUtility.getSortMark(ActivateDateComparator.class.getName(), params)%></th>
				<th class="ListSortTh" id="thEmployeeName" onclick="submitTransfer(event, null, null, new Array('<%=PlatformConst.PRM_TRANSFERRED_SORT_KEY%>', '<%=EmployeeNameComparator.class.getName()%>'), '<%=SpecialHolidayHistoryAction.CMD_SORT%>');"><%= params.getName("Employee") %><%= params.getName("FirstName") %><%=PlatformUtility.getSortMark(EmployeeNameComparator.class.getName(), params)%></th>
				<th class="ListSortTh" id="thSection" onclick="submitTransfer(event, null, null, new Array('<%=PlatformConst.PRM_TRANSFERRED_SORT_KEY%>', '<%=SectionCodeComparator.class.getName()%>'), '<%=SpecialHolidayHistoryAction.CMD_SORT%>');"><%= params.getName("Section") %><%=PlatformUtility.getSortMark(SectionCodeComparator.class.getName(), params)%></th>
				<th class="ListSortTh" id="thHolidayType" onclick="submitTransfer(event, null, null, new Array('<%=PlatformConst.PRM_TRANSFERRED_SORT_KEY%>', '<%=HolidayHistoryListHolidayCodeComparator.class.getName()%>'), '<%=SpecialHolidayHistoryAction.CMD_SORT%>');"><%= params.getName("Classification") %><%=PlatformUtility.getSortMark(HolidayHistoryListHolidayCodeComparator.class.getName(), params)%></th>
				<th class="ListSortTh" id="thHolidayGiving" onclick="submitTransfer(event, null, null, new Array('<%=PlatformConst.PRM_TRANSFERRED_SORT_KEY%>', '<%=HolidayHistoryListHolidayGivingComparator.class.getName()%>'), '<%=SpecialHolidayHistoryAction.CMD_SORT%>');"><%= params.getName("Giving") %><%= params.getName("Days") %><%=PlatformUtility.getSortMark(HolidayHistoryListHolidayGivingComparator.class.getName(), params)%></th>
				<th class="ListSortTh" id="thHolidayLimit" onclick="submitTransfer(event, null, null, new Array('<%=PlatformConst.PRM_TRANSFERRED_SORT_KEY%>', '<%=HolidayHistoryListHolidayLimitComparator.class.getName()%>'), '<%=SpecialHolidayHistoryAction.CMD_SORT%>');"><%= params.getName("Acquisition") %><%= params.getName("TimeLimit") %><%=PlatformUtility.getSortMark(HolidayHistoryListHolidayLimitComparator.class.getName(), params)%></th>
				<th class="ListSortTh" id="thInactivate" onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= InactivateComparator.class.getName() %>'), '<%= SpecialHolidayHistoryAction.CMD_SORT %>');"><%= params.getName("EffectivenessExistence") %><%= params.getName("Slash") %><%= params.getName("InactivateExistence") %><%= PlatformUtility.getSortMark(InactivateComparator.class.getName(), params) %></th>
			</tr>
		</thead>
		<tbody>
<%
