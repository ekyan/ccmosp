...
<div class="List" id="divSearch">
	<table class="InputTable">
		...
		<tr>
			...
			<td class="TitleTd"><label for="txtSearchPaidHolidayName"><%= params.getName("PaidHoliday","Code") %></label></td>
		...
		<tr>
			<td class="TitleTd"><label for="txtSearchPaidHolidayName"><%= params.getName("PaidHoliday","Name") %></label></td>
			...
			<td class="TitleTd"><label for="txtSearchPaidHolidayAbbr"><%= params.getName("PaidHoliday","Abbreviation") %></label></td>
...
<div class="FixList">
	<table class="LeftListTable" id="list">
		<tr>
			...
			<th class="ListSortTh" id="thPaidHolidayCode" onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= PaidHolidayMasterPaidHolidayCodeComparator.class.getName() %>'), '<%= PaidHolidayListAction.CMD_SORT %>')"><%= params.getName("PaidHoliday","Code") %><%= PlatformUtility.getSortMark(PaidHolidayMasterPaidHolidayCodeComparator.class.getName(), params) %></th>
			<th class="ListSortTh" id="thPaidHolidayName" onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= PaidHolidayMasterPaidHolidayNameComparator.class.getName() %>'), '<%= PaidHolidayListAction.CMD_SORT %>')"><%= params.getName("PaidHoliday","Name") %><%= PlatformUtility.getSortMark(PaidHolidayMasterPaidHolidayNameComparator.class.getName(), params) %></th>
			<th class="ListSortTh" id="thPaidHolidayAbbr" onclick="submitTransfer(event, null, null, new Array('<%= PlatformConst.PRM_TRANSFERRED_SORT_KEY %>', '<%= PaidHolidayMasterPaidHolidayAbbrComparator.class.getName() %>'), '<%= PaidHolidayListAction.CMD_SORT %>')"><%= params.getName("PaidHoliday","Abbreviation") %><%= PlatformUtility.getSortMark(PaidHolidayMasterPaidHolidayAbbrComparator.class.getName(), params) %></th>
