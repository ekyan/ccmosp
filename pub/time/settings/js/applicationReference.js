...
function hasSearchCondition() {
	return !isEmpty(
			...
			"pltSearchWorkPlaceMaster",
			"pltSearchEmploymentMaster",
			"pltSearchSectionMaster",
			"pltSearchPositionMaster",
			"txtSearchApplicationCode",
			"txtSearchApplicationName",
			"pltSearchTimeSetting",
			"pltSearchSchedule",
