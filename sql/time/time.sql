...
(
  tmd_timely_paid_holiday_id bigint NOT NULL DEFAULT 0,
  personal_id character varying(10) NOT NULL DEFAULT ''::character varying,
  activate_date date NOT NULL,
  acquisition_date date NOT NULL,
  possible_hour integer NOT NULL DEFAULT 0,
  giving_hour integer NOT NULL DEFAULT 0,
  cancel_hour integer NOT NULL DEFAULT 0,
  use_hour integer NOT NULL DEFAULT 0,
  inactivate_flag integer NOT NULL DEFAULT 0,
...
CREATE SEQUENCE tmd_timely_paid_holiday_id_seq;
...
CREATE INDEX tmd_timely_paid_holiday_index1 ON tmd_timely_paid_holiday(personal_id, activate_date, acquisition_date);
